...
syn region slideSectionMarkdown start="^#\+ "hs=e+1 end="$"he=s-1
syn match slideBullet "^-\+ "
syn match slideCode "^\(Tags\|Summary\|OldURL\):\+ "
syn region slidePrefomat start="^\s\+" end="$"
syn match slideCode "^\.\(code\|play\|image\|video\|background\|iframe\|link\|html\|caption\)" contains=slideOption,slideLink
...
hi link slideSectionMarkdown Identifier
